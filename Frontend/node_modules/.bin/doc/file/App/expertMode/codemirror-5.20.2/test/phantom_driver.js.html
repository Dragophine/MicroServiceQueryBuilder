...
<head>
  ...
  <title data-ice="title">App/expertMode/codemirror-5.20.2/test/phantom_driver.js | API Document</title>
...
<div class="content" data-ice="content"><h1 data-ice="title">App/expertMode/codemirror-5.20.2/test/phantom_driver.js</h1>
<pre class="source-code line-number raw-source-code"><code class="prettyprint linenums" data-ice="content">var page = require(&apos;webpage&apos;).create();
